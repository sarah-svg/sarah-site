export const projectsData = [
  {
    ...
    desc: 'Thinking about investing? Try our site with paper trading until you’re ready to use your own money.'
  ...
  },
  {
    ...
    desc: 'The application utlizes the GitHub api to access a users repos. With just the users name you are able to pull up the users profile with working links to the users page and their repos.'
  },
];